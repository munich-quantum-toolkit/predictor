...
MQT Predictor is a Python package available on
[PyPI](https://pypi.org/project/mqt.predictor/). It can be installed on all
...
```console
python -m pip install mqt.predictor
```
...
```console
python -c "import mqt.predictor; print(mqt.predictor.__version__)"
```
...
To use the MQT Predictor Python package in your project, add it as a dependency
...
Set up a reproducible development environment for MQT Predictor. This is the
