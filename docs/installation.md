...
To use the MQT Predictor Python package in your project, add it as a dependency in your {code}`pyproject.toml` or {code}`setup.py`.
...
[project]
# ...
dependencies = ["mqt.predictor>=<version>"]
# ...
```
...
setup(
    # ...
    install_requires=["mqt.predictor>=<version>"],
    # ...
)
```
...
Set up a reproducible development environment for MQT Predictor.
...
1.  Get the code:
    ...
    If you do not have write access to the [munich-quantum-toolkit/predictor](https://github.com/munich-quantum-toolkit/predictor) repository, fork the repository on GitHub (see <https://docs.github.com/en/get-started/quickstart/fork-a-repo>) and clone your fork locally.
    ...
    If you have write access to the [munich-quantum-toolkit/predictor](https://github.com/munich-quantum-toolkit/predictor) repository, clone the repository locally.
