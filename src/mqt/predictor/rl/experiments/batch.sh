...
printf 'Resolved command: PYTHONPATH=src python3 -u src/mqt/predictor/rl/experiments/training.py'
printf ' %q' "${ARGS[@]}"
printf '\n'

PYTHONPATH=src python3 -u src/mqt/predictor/rl/experiments/training.py "${ARGS[@]}"
